...
<section id="homeServices" class="bg-center bg-no-repeat bg-cover py-16" style="background-image: url('{{env('APP_URL')}}/public/PortfolioFile/images/demo/contact.jpg')">
