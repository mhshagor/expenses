...
<body>
    ...
    <main class="p-top-6rem p-md-top-10rem">
        ...
        <?php include("product-Details-Product.php") ?>
        <?php include("product-details-combo.php") ?>
        <?php include("product-details-details.php") ?>
        <?php include("product-details-recomanded-product.php") ?>
