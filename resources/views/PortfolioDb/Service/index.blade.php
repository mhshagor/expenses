		...
		<div class="sm:w-5/6 mx-auto border shadow-lg shadow-stone-400 rounded bg-white p-1 my-10">
			<div class="bg-stone-50 rounded">
				<section class="bg-stone-200 py-12 relative mb-1 rounded">
					<div>
						<h1 class="text-center text-2xl font-semibold py-3">Service</h1>
					</div>
					<div class="w-3/5 mx-auto border bg-stone-50 p-0.5 shadow-lg shadow-stone-400 rounded">
						
						<form method="post" action="{{route('portfolio-service-create')}}" class="px-10 py-5 bg-stone-300 rounded space-y-3">
							@csrf
							
							<!-- Icon -->
							<div class="relative">
								<label for="icon" class="block font-semibold text-md">Icon</label>
								<input id="icon" type="text" name="icon" class="w-full py-1 rounded" value="{{old('icon')}}" placeholder="Type icon">
								@error('icon')
			...
			<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg">
				...
				<tbody class="bg-gray-200 border-b border-gray-400">
					...
					<tr class="bg-blue-100 border-b hover:bg-gray-50 text-center text-black">
						...
						<td scope="row" class="px-6 py-1.5 font-medium whitespace-nowrap"></td>
