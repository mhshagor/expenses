                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                @else
                                    <a href="{{ $url }}" class="relative inline-flex items-center h-6 w-6 items-center justify-center text-sm font-medium text-gray-700 cursor-pointer hover:border-b-2 hover:border-blue-500 hover:text-blue-500 duration-300" aria-label="{{ __('Go to page :page', ['page' => $page]) }}">
                                        {{ $page }}
                                    </a>
                                @endif
                            @endforeach
