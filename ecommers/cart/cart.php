...
<body>
    ...
    <main class="p-top-6rem p-md-top-10rem">
        ...
        <?php include("cart-breadcrumb.php") ?>
        <?php include("cart-product-confirm-bar.php") ?>
        <?php include("cart-product-totals.php") ?>
        <?php include("cart-product-recomanded-product.php") ?>
